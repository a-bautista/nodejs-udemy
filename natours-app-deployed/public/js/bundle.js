...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYWxleGJyIiwiYSI6ImNrMTB2dmVxZzAwaGUzaG1jdDh3dW1oOGsifQ.2ThPr8V8yM7UFItkAFtfvQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/alexbr/ck10w5q46052d1cry7uu7ov8z',
    //center: [-106.8542342, 39.1985134], //lat and long
    //zoom: 9
    scrollZoom: false
  });
...
var stripe = Stripe('pk_test_lMrAVQKlNFoF44EvYZBZQq8O00vVNXAcee');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); // 2) Create checkout form + charge in credit card
